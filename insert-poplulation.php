                                ...
                                <div class="row">
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="familycity" type="number" class="form-control" placeholder="تعداد خانوار شهری"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="familyrural" type="number" class="form-control" placeholder="تعداد خانوار روستایی"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="familymen" type="number" class="form-control" placeholder="تعداد خانوار باسرپرست مرد"><span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="familywomen" type="number" class="form-control " placeholder="تعداد خانوار باسرپرست زن"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="allfamily" disabled type="text" class="form-control" placeholder="تعداد کل خانوار"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="allpeople" type="number" class="form-control" placeholder="تعداد کل نفرات"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="familyoldcity" type="number" class="form-control" placeholder="تعداد خانوار سالمند شهری"><span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="familyoldrural" type="number" class="form-control " placeholder="تعداد خانوار سالمند روستایی"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="alloldfamily" disabled type="text" class="form-control" placeholder="تعداد کل خانوار سالمند"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="peopleoldcity" type="number" class="form-control" placeholder="تعداد نفرات سالمند شهری"><span></span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="peopleoldrural" type="number" class="form-control " placeholder="تعداد نفرات سالمند روستایی"><span></span>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-4">
                                        <div class="input-group mb-2">
                                            ...
                                            <input required name="alloldpeople" disabled type="text" class="form-control" placeholder="تعداد کل نفرات سالمند"><span></span>
                                        </div>
                                    </div>
                                    <div class="pt-4">
